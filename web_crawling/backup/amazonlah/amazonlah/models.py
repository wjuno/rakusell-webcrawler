...
class ProductDetailRecord(object):
    ...
    def __init__(self, title, product_url):
    ...
    def save(self):
        # cur.execute("INSERT INTO products_details (title,product_url) VALUES (%s, %s) RETURNING id", (
        #     self.title,
        #     # self.category,
        #     # self.availability,
        #     # self.original_price,
        ...
        cur.execute("UPDATE products_details SET title = %s where product_url = %s", (
            self.title,
            # self.category,
            # self.availability,
            # self.original_price,
